...
cell_markers = {'http://purl.obolibrary.org/obo/CL_0000084': ['CD3+'],
...
import_labels = {'http://purl.obolibrary.org/obo/CL_0000084': ('T: T cell', 'T cell'),
...
for url, cell_type in cell_markers.items():
